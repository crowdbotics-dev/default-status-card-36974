...
## Project Structure
    ...
    ├── default_status_card_36974  # Django project configurations
...
1. Clone this repo and `cd default_status_card_36974`
...
2. Clone this repo and `cd default_status_card_36974`
